...
import EmploymentStep from "./register/EmployeeStep";
...
const MultiForm = () => {
    ...
    const validateStep = () => {
        ...
        //employment status
            ...
            // // if (!userData.salary_range) newErrors.salary_range = "Salary Range is required";
        ...
        <div>
            ...
            <div className="flex justify-center items-center min-h-[calc(100vh-64px)] bg-gray-100">
                <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-8">
                    ...
                    {step === 3 && <EmploymentStep userData={userData} setUserData={setUserData}
                        handleChange={handleChange} errors={errors}
                        currentStepIndex={currentStepIndex} totalSteps={totalSteps}
                    />}
