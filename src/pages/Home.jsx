        ...
        <div className="flex flex-col w-full min-h-screen">
            ...
            >
                <div className="relative max-w-7xl bg-gray-100 p-6 md:p-10 rounded-lg text-center shadow-lg">
                    <h1 className="text-2xl md:text-4xl font-bold text-gray-900 text-start mt-5">
            ...
            <section className="h-1/3 flex flex-col justify-center items-center bg-red-500 text-white text-center px-4">
                <p className="text-lg md:text-xl m-6">
                    Join <span>AlumniLink</span> and be a part of a community that values your growth and success
                </p>
            </section>
                    ...
                    <div className="mt-8 flex justify-center gap-8 flex-wrap">
                        {filteredPosts.map((event, index) => {
                            ...
                            return (
                                ...
                                >
                                    <img
                                        src={`${import.meta.env.VITE_STORAGE_BASE_URL}/public/storage/event_images/${event.event_image}` || UmLogo}
